...
root CA, intermediate CA levels, and client/server certificates. It also exports
trust bundles for distribution.

## What this project does

- Creates a root CA (self-signed)
- Creates intermediate CAs (level1 -> level2 -> level3-client/level3-server)
- Issues client certificates signed by the level 3 client CA
- Issues server certificates signed by the level 3 server CA
...
- `scripts/make/03_make_level3_client.sh`: create level 3 client CA signed by level 2
- `scripts/make/03_make_level3_server.sh`: create level 3 server CA signed by level 2
- `scripts/make/04_make_client.sh`: issue a client certificate from level 3 client CA
- `scripts/make/04_make_client_from_csr.sh`: sign a client CSR with level 3 client CA
- `scripts/make/04_make_server.sh`: issue a server certificate from level 3 server CA
- `scripts/make/04_make_server_from_csr.sh`: sign a server CSR with level 3 server CA
...
- `scripts/import/03_import_level3_client.sh`: import level 3 client key/cert bundle
- `scripts/import/03_import_level3_server.sh`: import level 3 server key/cert bundle
...
- Server creation accepts `[server_cn] [san] [days] [key_bits]`.
